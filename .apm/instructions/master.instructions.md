...
- When the work is a single GitHub UI-only edit with no branch, commit, or PR, such as updating an issue body or toggling an acceptance checkbox, perform that edit directly instead of opening a sub-issue.
