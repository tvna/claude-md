...
| `pr_body_close_keyword_advisory.py` | IA, DE | PreToolUse advisory only; surfaces a warning when a PR body uses only `Refs:` instead of a closing keyword. | `tests/test_pr_body_close_keyword_advisory.py`, `docs/issue-pr-body-standard.md`, #219 | covered | — |
...
| `docs/issue-pr-body-standard.md` | DE, RD, IA | Documents body section requirements; trusted-bot carve-out; advisory hook integration. | `verify-body-policy.yml`, `scripts/body_policy.py`, `scripts/pr_body_close_keyword_advisory.py`, #206 | covered | — |
