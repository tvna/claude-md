...
flowchart TD
    ...
    N006["print(...)"]
    N007["return 1"]
    N008["if not glossary_path.exists()"]
    N009["print(...)"]
    N010["return 1"]
    ...
    N043["glossary_entries = parse_file_entries(...)"]
    N044["missing_glossary = sorted(...)"]
    N045["if missing_glossary"]
    N046["labels = join(...)"]
    N047["print(...)"]
    N048["failures += 1"]
    N049["if failures"]
...
flowchart TD
    ...
    N003["print(...)"]
    N004["return 2"]
    N005["return _verify(Path(args.master), Path(args.doc), Path(args.glossary))"]
    N001 -->|"start"| N002
    N002 -->|"true"| N003
    N003 --> N004
    N002 -->|"false"| N005
