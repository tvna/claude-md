...
- **unlabelled ratio 0.94**: 98 of 104 observed retros carry no `retro:*` label (>= 0.50, n >= 5); retros are being opened faster than they are triaged.

## Loop health

- Triage rate: **6 / 104** (6%) of observed retros carry a `retro:*` label; **98** (94%) remain unlabelled.
...
| --- | --: | --: | --: | --: | --: | :-: |
| `inline_review_comments` | 33 | 0.32 | 0 | 0.00 | 33 |  |
| `fix_typed_title` | 7 | 0.07 | 0 | 0.00 | 7 |  |
| `multi_commit_pr` | 39 | 0.38 | 0 | 0.00 | 39 |  |
