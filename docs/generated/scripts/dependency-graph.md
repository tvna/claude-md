...
| `_trusted_bots` | 9 | `_auto_retro_parse`, `auto_retro`, `body_policy`, `dependabot_automerge`, `issue_link`, `scan_non_ascii`, `scan_review_in_progress_marker`, `title_policy`, `verify_dependabot_author` |
...
| `_json_schema_subset` | 2 | `scan_gitapex_schema`, `scan_ssot_schema` |
...
| `preflight_push_base` | 1 | `preflight_push_dispatch` |
| `preflight_push_nonempty` | 1 | `preflight_push_dispatch` |
| `preflight_push_session_branch` | 1 | `preflight_push_dispatch` |
| `preflight_push_unsigned_commits` | 1 | `preflight_push_dispatch` |
...
flowchart TD
    ...
    preflight_coauthor_trailer --> _git
    ...
    preflight_push_dispatch --> _hook_runtime
    preflight_push_dispatch --> preflight_push_base
    preflight_push_dispatch --> preflight_push_nonempty
    preflight_push_dispatch --> preflight_push_session_branch
    preflight_push_dispatch --> preflight_push_unsigned_commits
    ...
    publish_instruction_release --> _git
    ...
    scan_gitapex_schema --> _json_schema_subset
