...
| `scan_gitapex_schema.py` | pre-commit | `scan-gitapex-schema` |
| `scan_gitapex_schema.py` | workflow | `verify-pr.yml (portable-pr-policy)` |
...
| `scan_workflow_llm_budget.py` | pre-commit | `scan-workflow-llm-budget` |
| `scan_workflow_llm_budget.py` | workflow | `verify-agents.yml (lint-scripts-static)` |
