...
| [devin-apm-compatibility.md](prd/devin-apm-compatibility.md) | APM-first compatibility design for formally supporting Devin with shared `.agents/skills` and a small Devin hook adapter. | #982 | `.agents/skills`; `.devin/hooks.v1.json`; `tests/test_devin_hooks_config.py` |
