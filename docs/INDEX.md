...
| [semantic-versioning-universal-text.md](prd/semantic-versioning-universal-text.md) | Compatibility-based semver for the universal text; drift gate, post-merge `v{version}` auto-tag. | #89 | `apm.yml` |
