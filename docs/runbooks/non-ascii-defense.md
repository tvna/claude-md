...
> Design rationale: see [`docs/prd/agent-rules-design-philosophy.md`](../prd/agent-rules-design-philosophy.md). This runbook is the concrete three-layer ASCII discipline that enforces principle P3 at the GitHub-post boundary.
...
| `docs/runbooks/non-ascii-defense.md` *(this file)* | (none) | Runbook |
...
- [`docs/runbooks/rulesets.md` lines 48-51](rulesets.md); original prompt-injection note (links here as "See also")
