...
| `verify-body-policy.yml` | DE, RD | PR + issue body section structure check; cutoff date isolates legacy items. | `scripts/body_policy.py`, `tests/test_body_policy.py`, `docs/standards/issue-pr-body-standard.md`, #206 | covered | — |
...
| `verify-issue-link.yml` | IA, DE | PR gate: body must reference at least one valid issue; closing-keyword advisory. | `scripts/issue_link.py`, `tests/test_issue_link.py`, `docs/standards/issue-pr-body-standard.md` | covered | — |
| `verify-title-policy.yml` | DE, RD | Title ASCII / format gate on PRs and issues. | `scripts/title_policy.py`, `tests/test_title_policy.py`, `docs/prd/non-ascii-defense.md` | covered | — |
...
| `issue_link.py` | IA, DE | PR gate; validates issue references via same-repo `gh api`; applies advisory labels. | `tests/test_issue_link.py`, `verify-issue-link.yml`, `docs/standards/issue-pr-body-standard.md` | covered | — |
...
| `title_policy.py` | DE, RD | ASCII / format validator for issue and PR titles; pure function. | `tests/test_title_policy.py`, `verify-title-policy.yml`, `docs/prd/non-ascii-defense.md` | covered | — |
...
| `docs/standards/issue-pr-body-standard.md` | DE, RD, IA | Documents body section requirements; trusted-bot carve-out; advisory hook integration. | `verify-body-policy.yml`, `scripts/body_policy.py`, `scripts/pr_body_close_keyword_gate.py`, #206 | covered | — |
...
| RD | `verify-title-policy.yml`, `scan-non-ascii.yml`, `verify-body-policy.yml`, `.github/dependabot.yml`, `uv.lock`, `pyproject.toml`, `dependabot.json` ruleset, `docs/runbooks/agent-provenance.md` | covered | — |
...
| LM | `.apm/instructions/master.instructions.md`, `CLAUDE.md`, `AGENTS.md`, `verify-apm-drift.yml`, `generate-agents.yml`, `docs/runbooks/agent-provenance.md` | partially covered | #183 |
