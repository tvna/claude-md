...
# per-file INDEX linking requirement. docs/generated/scripts/ holds one
# auto-generated AST doc per script, regenerated by the post-merge automation
# (#1540); listing each file in docs/INDEX.md would drift as scripts are added
# or removed, so the directory is described once in INDEX and skipped here.
EXEMPT_INVENTORY_PREFIXES = ("docs/generated/scripts/",)
