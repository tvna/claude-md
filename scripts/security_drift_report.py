...
plan`, `uv_pin.py drift`, `uv_pin.py stale`) and the verify-apm-drift
...
def classify_apm(*, rc: int) -> FamilyRow:
    evidence = ".github/workflows/verify-apm-drift.yml"
...
def _assemble_families(args: argparse.Namespace) -> list[FamilyRow]:
    ...
    return [
        ...
        pr_gate_only_row(
            family="title-policy",
            detector=".github/workflows/verify-title-policy.yml",
