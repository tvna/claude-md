...
class TestFooterCarryForward:
    def test_carries_harness_footer_from_stored_body(self) -> None:
        # Web-harness create: authored body has no footer (relaxed); the
        # harness appended one to the stored body. The fixer must carry it
        # into the normalized body so the mandated update is not denied.
